    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (email.isEmpty()) {
            ...
            if (test == JOptionPane.YES_OPTION) {
                final String username = "kaneorvinh@gmail.com";
                final String password = "lamyentu146";
...
//                final String password1 = "lmwbnovskahwojlt";
                ...
                try {
                    ...
                    message.setFrom(new InternetAddress("kaneorvinh@gmail.com"));
                    message.setRecipients(
                            Message.RecipientType.TO,
                            InternetAddress.parse(txtEmail.getText().trim())
                    );
                    message.setSubject("Võ Đường ABC - Mật khẩu đặt lại là: " + matkhaurd);
